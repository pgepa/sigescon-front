...
export type Contrato = { id: number; nr_contrato: string; objeto: string; valor_anual: number | null; valor_global: number | null; data_inicio: string; data_inicio_original?: string | null; data_fim: string; data_fim_original?: string | null; contratado_id: number; modalidade_id: number; status_id: number; gestor_id: number; fiscal_id: number; fiscal_substituto_id: number | null; pae: string | null; doe: string | null; data_doe: string | null; garantia: string | null; base_legal?: string | null; termos_contratuais?: string | null; modalidade_nome?: string; contratado_nome?: string; status_nome?: string; gestor_nome?: string; fiscal_nome?: string; fiscal_substituto_nome?: string; total_aditivos?: number; };
...
export type TermoAditivo = {
    ...
    ativo: boolean;
    status?: "Ativo" | "Vencido" | "Inativo" | "Aguardando Vigência" | "Incorporado" | null;
    created_at?: string;
    updated_at?: string;
};
...
export type TermoAditivoRelatorioItem = {
    ...
    status_calc: "Ativo" | "Vencido" | "Inativo" | "Aguardando Vigência" | "Incorporado";
};
